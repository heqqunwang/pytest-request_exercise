...
class Goods(BaseApi):
	...
	def query_goods(self,goodsname=None,goodssn=None,GoodsID=None):##name，goodsSN，goodsID的值可为空
		##查询管理后台商品，获取到商品id

		query_admin_url = "/admin/goods/list"
		goods_data = {"name": goodsname, "goodsSn":goodssn,"goodsId":GoodsID,"order": "desc", "sort": "add_time"}
		...
		if self.exist >= 1:
			self.goods_id = r["data"]["list"][0]["id"]  ##取列表的第一个
